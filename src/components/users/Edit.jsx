    ...
    <div className="row flex-nowrap">
      ...
      <div className="col py-3">
        ...
        <form onSubmit={sendData}>
          <Input value={user.name} errors={errors} id={'username'} title='user name' type={'text'} name={'name'} handelData={handelData} />
          <Input value={user.email} errors={errors} id={'email'} title='email' type={'email'} name={'email'} handelData={handelData} />
          <Input value={user.password} errors={errors} id={'password'} title='user password' type={'password'} name={'password'} handelData={handelData} />
          <input type="submit" id='submit' name='submit' className="bg-info w-50 rounded-pill py-2" />
        </form> 
      </div>
